...
/**
 * AuroraTextEffect Component
 * @param {Object} props
 * @param {string} props.text - The text to display
 * @param {string} [props.className] - Container class
 * @param {string} [props.textClassName] - Text class
 * @param {string} [props.fontSize] - Font size (CSS value)
 * @param {Object} [props.colors] - Aurora colors
 * @param {string} [props.blurAmount] - Blur level
 * @param {Object} [props.animationSpeed] - Animation timings
 */
  ...
  return (
    ...
    >
      ...
      <div className="text-center">
        <h2
          className={cn(
            "font-extrabold tracking-tight relative overflow-hidden text-[#1A1A1A] dark:text-white",
            textClassName
          )}
          style={{ fontSize }}
        >
