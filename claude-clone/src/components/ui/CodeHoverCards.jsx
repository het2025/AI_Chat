...
const DEFAULT_CARDS = [
  { id: '1', icon: GitBranch, title: 'Repository', description: 'Code repository' },
...
const CodeHoverCards = ({
  ...
  return (
    <div className={cn('w-full flex items-center justify-center px-0 py-4 bg-transparent text-gray-900 dark:text-gray-100', className)}>
            ...
            return (
              ...
              >
                <div
                  ...
                  className={cn(
                    'relative w-full h-full flex items-center justify-center overflow-hidden cursor-pointer transition-all duration-200 bg-gray-50 border-gray-200 dark:bg-[#1A1A1A] dark:border-gray-800',
                ...
                >
                  {/* Icon */}
                  <div className="relative z-10 text-gray-800 dark:text-gray-300">
                    <IconComponent
                      size={iconSize}
                  ...
                  {/* Gradient overlay */}
                  <div className="absolute inset-0 pointer-events-none z-[5] bg-gradient-to-t from-gray-100/50 to-transparent dark:from-[#202425]/50 dark:to-transparent" />

                  {/* Character background */}
                  <div
                    className="absolute inset-0 text-sm leading-tight opacity-0 group-hover:opacity-100 transition-opacity duration-500 overflow-hidden break-all text-emerald-600 dark:text-emerald-500"
                    style={{
                      WebkitMaskImage:
                        'radial-gradient(' +
                        maskRadius +
